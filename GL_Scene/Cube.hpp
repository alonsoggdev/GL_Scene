 ...
 * tamaño específico y con la opción de invertir las normales. Hereda de la clase `Mesh` y
 * aprovecha sus funcionalidades para el procesamiento y renderizado del cubo en un entorno OpenGL.
 */
namespace udit
{
    ...
    private:
         ...
         *
         * Esta función genera el cubo con un tamaño y las posibles modificaciones sobre las normales.
